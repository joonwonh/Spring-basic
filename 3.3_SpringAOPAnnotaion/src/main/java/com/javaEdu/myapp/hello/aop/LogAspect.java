...
public class LogAspect {
	@Pointcut(value="execution(* com.javaEdu..*.sayHello(..))")
		private void helloPointcut()		{}
	
	@Pointcut(value="execution(* com.javaEdu..*.sayGoodbye(..))")
	...
	public Object trace(ProceedingJoinPoint joinPoint) throws Throwable	{
		...
		Object result = null;
		try {
			result = joinPoint.proceed();	//sayHello() 실행 시킴
		}catch(Exception e)	{
